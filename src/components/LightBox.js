  ...
  return (
    <Background>
      ...
      <Container ref={lightBoxRef}>
        ...
        <Content>
          <b>活動時間│2022/05/31-2022/06/12</b>
          <br />
          ...
          <br />
          <br />
          馳加號召全台百位司機參加「米其林認證保養 VS. 最強職人
          滿意度大挑戰」活動，車主只要確實填寫問卷，將有機會獲得「免費體驗米其林認證保養+換胎服務」，獎項包含輪胎更換（4顆）含四輪定位（註1）、機油更換一次、愛車健檢服務一次（註2）；10位幸運獲獎車主將於06/15公佈於活動網頁中，並於06/16-06/17由專人電話通知並安排體驗時間（註3），讓您的愛車享受五星保養服務。
          <br />
          註1：輪胎型號將以原廠配置規格與台灣米其林官方在台販售花紋為主，若車主自行改裝升級輪胎者，須補足差價，差價包含輪胎售價以及相關升級造成之拆卸定位等技術服務費用，若遇指定規格缺貨，台灣米其林有權改提供同規格之其他花紋商品，贈品不得轉賣，換胎體驗結束後不會重新拆除/安裝；馳加可協助回收車主舊有輪胎，若車主有需要亦可自行將卸除之舊胎自行載回。
          <br />
          ...
          <br />
          5.
          依中華民國稅法規定，中獎價值如超過新台幣$1,000元（含）以上者，獎項所得將列入個人年度綜合所得稅申報，故得獎人需依規定填寫領獎收據及繳交兌獎者身分證正反面影本（若未達法定年齡，尚無身分證者，請附上戶口名簿影本，並須由父母或監護人代為領取），在活動主辦單位確認兌獎資格後，方可領獎。若贈品所得總額超過NT$20,000，需另繳納10%稅額，若無法配合，則視為自動棄權，不具得獎資格。
          <br />
          6.
          獲獎者簽收獎項後，若有遺失或被竊等喪失佔有之情形，主辦單位不負補發獎項之責任。
          <br />
          7.
